{
 "cells": [
  ...
  {
   "cell_type": "markdown",
   "id": "e1d752ce-d1b1-4a2f-af07-3c3028939f6f",
   "metadata": {},
   "source": [
    "Katsotaan ensin miltä opetus- ja validointikäyrät voisivat näyttää"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "d81addd5-566d-42c7-9107-89ab5d09f953",
   "metadata": {},
   "outputs": [],
   "source": [
    ...
    "\n",
    "history = model.fit(X_train, y_train, validation_split=0.2, epochs=100, batch_size=12)\n",
    "\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "528c1a5a-0bd4-4a8f-9f82-c0d81f0112f7",
   "metadata": {},
   "outputs": [],
   "source": [
    "import matplotlib.pyplot as plt\n",
    ...
    "plt.ylabel('Accuracy')\n",
    "plt.legend()\n",
    "plt.suptitle(f\"Evaluointitarkkuus : {accuracy*100:.5f}\")\n",
    "plt.tight_layout()"
   ]
  },
  {
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Yhteensä 32 konfiguraatiota, aloitetaan... gs_dnn_20230518T1844\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 19,
   "id": "96df976d-e523-44b4-8f10-d6a0cb2496ac",
   "metadata": {},
   "outputs": [],
   "source": [
