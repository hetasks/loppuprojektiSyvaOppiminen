{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "df_breastCancer = pd.read_csv(\"C:/Users/hetas/Desktop/Syksy/syväoppiminen/lopputyo_SyvaOppiminen/Breast_Cancer.csv\", sep=\",\")\n",
    "\n",
    ...
    "\n",
    "# muuta tämä sopimaan GitHubin kanssa"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Yhteensä 32 konfiguraatiota, aloitetaan... gs_dnn_20230517T1826\n",
